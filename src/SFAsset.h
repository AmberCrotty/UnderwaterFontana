 ...
 */
enum SFASSETTYPE {SFASSET_DEAD, SFASSET_PLAYER, SFASSET_PROJECTILE, SFASSET_ALIEN, SFASSET_SECONDALIEN, SFASSET_THIRDALIEN, SFASSET_COIN, SFASSET_WALL};
...
public:
  ...
  virtual int       Lives();
  virtual void      EnemyLives(int);
  virtual void      SetLives(int amount);
  virtual void      Movespeed();
